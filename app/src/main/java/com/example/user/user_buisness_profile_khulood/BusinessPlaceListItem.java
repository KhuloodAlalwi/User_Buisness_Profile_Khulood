...
public class BusinessPlaceListItem {
    ...
    public BusinessPlaceListItem(int placeImageUserLikes, String placeNameUserLikes, String placeDescUserLikes, int likeImageUser, int bookmarkImageUser, int ratingbarBusiness) {
